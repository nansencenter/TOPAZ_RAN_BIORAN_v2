    ...
    for iy in range(year,year+1):
        ...
        if isfull:
            ...
            while current_datetime <= end_datetime:
                ...
                if isesaoccci:
                    ...
                    #
                    input_directory = "/cluster/projects/nn2993k/OCCCI/1D_4KM_GEO/v6.0/"+year
            ...
            if isaggregate:
                 ...
                 ncfile = tpvar+"_"+obs_date+"_full.nc"
                 symlink_path = ncfile
                 os.symlink(file_path, symlink_path)
                 os.chdir(work_directory)
                 print("INFO - "+formatted_time+" - Successfully simlinked to "+symlink_path)
        ...
        if issubset:
            ...
            if isaggregate:
                ...
                output_filename = tpvar+"_"+obs_date_range+"_subset.nc"
            else:
